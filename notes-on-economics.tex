...
Nabavi, N. \emph{Notes on Economics: Applied Economics, Econometrics, and Policy Evaluation}.

Bookdown project. \href{https://doi.org/10.5281/zenodo.20737021}{\includesvg{notes-on-economics_files/3b7270fbd6f7cdff52bccb36c3d8f06730ee15d2.svg}}
...
{\centering \includegraphics[width=1\linewidth]{images/01_econ_system_map} 
...
{\centering \includegraphics[width=1\linewidth]{images/02_supply_demand_surplus} 
...
\begin{center}\includegraphics{notes-on-economics_files/figure-latex/incidence-mini-sim-1} \end{center}
...
{\centering \includegraphics[width=1\linewidth]{images/03_macro_dashboard} 
...
{\centering \includegraphics[width=1\linewidth]{images/04_policy_transmission} 
...
{\centering \includegraphics[width=1\linewidth]{images/05_ols_with_residuals} 
...
{\centering \includegraphics[width=0.95\linewidth]{images/06_multivariate_coefficients} 
...
{\centering \includegraphics[width=1\linewidth]{images/07_time_series_components} 
...
{\centering \includegraphics[width=1\linewidth]{images/08_identification_strategies} 
...
{\centering \includegraphics[width=1\linewidth]{images/09_itsa_level_slope} 
...
{\centering \includegraphics[width=0.95\linewidth]{images/10_itsa_workflow} 
...
\chapter{Evidence, Policy, and Interpretation}\label{evidence-policy}
...
\section{Theory, evidence, and causal reasoning}\label{theory-evidence-and-causal-reasoning}
...
\section{Assumptions, uncertainty, and real-world complexity}\label{assumptions-uncertainty-and-real-world-complexity}
...
\section{Interpretation, communication, and final reflections}\label{interpretation-communication-and-final-reflections}
